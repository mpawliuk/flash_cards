...
def game():
  ...
  add_percent= clean_input("What percentage of addition problems do you want?\n (Choose integer 0-100) ",0,100)

  low = clean_input("What is the smallest number in the range?\n (Choose any integer) ",-1000,1000)

  high = clean_input("What is the largest number in the range?\n (Choose any integer) ",-1000,1000)

  n = clean_input("How many examples do you want?\n (Choose any integer) ",1)
